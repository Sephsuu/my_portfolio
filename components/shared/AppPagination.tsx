...
export function AppTablePagination<T>({ data, page, size, setPage, paginated, search, filter, pageKey, totalItems }: {
    data: T[];
    paginated: T[];
    page: number;
    size: number;
    ...
    const totalItemCount = totalItems ?? data?.length ?? 0;
            ...
            <div className="text-sm text-gray">
                {(() => {
                    ...
                    return totalItemCount
                        ? `Showing ${start}-${end} of ${totalItemCount} items`
                        : "Showing 0 items";
                })()}
            </div>
