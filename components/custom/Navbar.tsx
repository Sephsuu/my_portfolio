                ...
                <div className="flex w-full max-w-lg items-center justify-between gap-3">
                    {routes.map((item) => (
                        <a
                            key={item.title}
                            href={item.href}
                            className="rounded-sm text-sm transition-opacity hover:opacity-60 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-black sm:text-lg"
                        >
                            {item.title}
                        </a>
                    ))}
